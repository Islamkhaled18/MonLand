    ...
    <main class="app sidebar-mini rtl">
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item"><a href="{{ route('terms.index') }}" title="الشروط والحكام ">الشروط والحكام </a></li>
                <li class="breadcrumb-item active"><a href="{{ route('terms.create') }}"  title="  انشاء شروط احكام جديده">إانشاء شروط احكام جديده</a></li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
