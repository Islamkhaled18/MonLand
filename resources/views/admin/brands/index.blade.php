                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $brand->name }}</td>
                                <td><img src="{{ $brand->image_url }}" title="{{ $brand->name }}" alt="{{ $brand->name }}" width="60" height="60">
                                </td>

                                <td>
                                    @can('brands.edit')
                                    <a class="btn btn-sm btn-dark" title="تعديل" href="{{ route('brands.edit', ['id' => $brand->id]) }}">تعديل</a>
                                    @endcan
                                    @can('brands.edit')
