    ...
    <main class="app sidebar-mini rtl">
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('DeliveryPolicy.create') }}"  title="  انشاء سياسة شحن جديده">إانشاء سياسة شحن جديده</a></li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="col-lg-6">
                            <form action="{{route('DeliveryPolicy.store')}}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleInputEmail1" name="policy"></textarea>
                                @error('policy')
