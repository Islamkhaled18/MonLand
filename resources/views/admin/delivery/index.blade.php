                            ...
                            <tbody>
                                @foreach ($deliveries as $delivery)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-dark" href="{{ route('delivery.edit',['id'=>$delivery->id]) }}">تعديل</a>
                                            <form action="{{route('delivery.destroy', $delivery->id)}}" method="post" style="display: inline-block">
                                                @csrf
                                                @method('GET')
