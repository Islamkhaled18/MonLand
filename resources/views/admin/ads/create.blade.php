...
<main class="app sidebar-mini rtl">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('ads.create') }}" title="انشاء صورة اعلان جديده">إانشاء صورة اعلان جديده</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="col-lg-6">
                        <form action="{{route('ads.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="exampleInputEmail1" name="name" value="{{old('name')}}" type="text" placeholder="اكتب اسم الاعلان">
                                @error('name')
