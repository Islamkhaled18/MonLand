...
<main class="app sidebar-mini rtl">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('products.edit', $product->id) }}" title="تعديل على منتج">تعديل على منتج -
                    {{ $product->name }}</a></li>
        </ul>
    </div>
    <div class="row">
                    ...
                    <div class="col-lg-6">
                        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="exampleInputEmail1" name="name" value="{{ $product->name }}" type="text" placeholder="اسم المنتج">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder=" اسم بالرابط " value="{{ $product->slug }}" name="slug">
                                @error('slug')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="exampleInputEmail1" name="anotherInformation" value="{{ $product->anotherInformation }}" type="text" placeholder='معلومات اخرى'>
                            ...
                            <div class="form-group mt-1">
                                <input type="checkbox" value="{{ $product->is_active }}" name="is_active" id="switcheryColor4" class="switchery" data-color="success" checked />
                            ...
                            <div class="form-group mt-1">
                                <input type="checkbox" value="{{ $product->featured }}" name="featured" id="switcheryColor4" class="switchery" data-color="success" checked />
                            ...
                            <div class="form-group mt-1">
                                <input type="checkbox" value="{{ $product->deal_of_the_day }}" name="deal_of_the_day" id="switcheryColor4" class="switchery" data-color="success" checked />
                            ...
                            <div class="form-group mt-1">
                                <input type="checkbox" value="{{ $product->flash_sale }}" name="flash_sale" id="switcheryColor4" class="switchery" data-color="success" checked />
                            ...
                            <div class="form-group mt-1">
                                <input type="checkbox" value="{{ $product->quick_request }}" name="quick_request" id="switcheryColor4" class="switchery" data-color="success" checked />
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="price" class="form-control" placeholder="  سعر المنتج " value="{{ $product->price }}" name="price">
                                            @error('price')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" style="display:none" id="qtyDiv">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="sku" class="form-control" placeholder="  " value="{{ $product->qty }}" name="qty">
                                        @error('qty')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
