                            ...
                            <form enctype="multipart/form-data" method="post"
                                ...
                                <div class="col-md-12 border-right-2 border-right-blue-400">
                                    <div class="form-group ">
                                        <label class="col-lg-2 col-form-label font-weight-semibold">عبارة الترحيب<span
                                    ...
                                    <div class="form-group ">
                                        <label class="col-lg-2 col-form-label font-weight-semibold">رسالة ترحيبيه<span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <input name="welcome_subject" value="{{ $setting['welcome_subject'] }}" required
                                                type="text" class="form-control" placeholder="Welcome subject">
                                        </div>
                                    </div>
                                    {{-- <div class="form-group ">
                                        <label class="col-lg-2 col-form-label font-weight-semibold"><span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <input name="content_question" value="{{ $setting['content_question'] }}"
                                                required type="text" class="form-control" placeholder="Content Question">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <label class="col-lg-2 col-form-label font-weight-semibold"> البريد الالكتروني<span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="form-group ">
                                        <label class="col-lg-2 col-form-label font-weight-semibold"> الهاتف<span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <input name="phone" value="{{ $setting['phone'] }}" required
                                    ...
                                    <div class="form-group ">
                                        <label class="col-lg-2 col-form-label font-weight-semibold"> اليوتيوب<span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <input name="youtube" value="{{ $setting['youtube'] }}" required
                                    ...
                                    <div class="form-group ">
                                        <label class="col-lg-2 col-form-label font-weight-semibold"> تويتر<span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <input name="twitter" value="{{ $setting['twitter'] }}" required
