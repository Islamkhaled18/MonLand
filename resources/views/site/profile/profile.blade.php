                        ...
                        @foreach ($addresses as $address)
                            <div class="address-card col-md-5 m-3 p-2">
                                <div class="title border-bottom  px-0 py-2">
                                    ...
                                    <div class="col-2 ">
                                        <form action="{{ route('site.profile.destroyAddress', $address->id) }}"
                                            title="حذف" method="post">
                                            @csrf
                                            @method('GET')
                                ...
                                <div class="position-relative">
                                    <div class="position-absolute w-100 p-3 item-assets">
                                        <form action="{{ route('cart.store') }}" method="POST">
                                            @csrf
                                            <button type="submit" name="product_id" value="{{ $favProduct->id }}"
                                    ...
                                    <img class="card-img-top"
                                        src="{{ $favProduct->images[0]->photo ? asset($favProduct->images[0]->photo) : asset('images/default.png') }}"
                                        alt="{{ $favProduct->name }}" width="200" height="200" />
                                </div>
                    ...
                    <form action="{{ route('site.profile.password.update', auth()->user()->id) }}" method="POST">
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <div class=" password-input row align-items-center">
                                <input type="password" class="form-control col-11" id="inputOldPassword"
                                    name="old_password" placeholder="ادخل كلمة المرور القديمة">
