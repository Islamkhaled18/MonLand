<div id="modal_view_1" class="modal fade quickview in quickview-modal-product-details-{{$product ->id}}" tabindex="-1" role="dialog">
                        ...
                        <div class="product-prices">
                            <div class="product-price " itemprop="offers" itemscope="" itemtype="https://schema.org/Offer">
                                <div class="current-price">
                                    <span itemprop="price" class="price">السعر :{{$product ->special_price ?? $product ->price }}</span>
