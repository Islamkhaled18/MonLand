            ...
            <div class="row">
                <div class="col-3 text-right pr-0">
                    ...
                    <div>
                        ...
                        <div class="d-flex available-colors flex-nowrap">
                            @foreach ($productColors as $pc)
                                <div data-color="{{ $pc->name }}" class="pcColor"
                                    style="background-color: {{ $pc->name }}"></div>
                            @endforeach
                        </div>
                    </div>
                            ...
                            <div class="row align-items-center">
                                @foreach ($productSizes as $pz)
                                    <div class="col-6 d-flex align-items-center">
                                        <input type="radio" value="{{ $pz->name }}" name="size" id="sizes"
                                            class="position-relative size" />
                    ...
                    <div class="my-4">
                        ...
                        <form>
                            <div class="d-flex align-items-center">
                                <input value="5" type="radio" name="brand" id="five-stars"
                                    class="position-relative stars" />
                            ...
                            <div class="d-flex align-items-center">
                                <input value="4" type="radio" name="brand" id="four-stars"
                                    class="position-relative stars" />
                                <label for="four-stars" class="mr-2 d-flex justify-content-between">
                                    <div class="star-rating ml-3">
                                        <i class="fa-solid fa-star"></i>
                            ...
                            <div class="d-flex align-items-center">
                                <input value="3" type="radio" name="brand" id="three-stars"
                                    class="position-relative stars" />
                            ...
                            <div class="d-flex align-items-center">
                                <input value="2" type="radio" name="brand" id="two-stars"
                                    class="position-relative stars" />
                            ...
                            <div class="d-flex align-items-center">
                                <input value="1" type="radio" name="brand" id="one-stars"
                                    class="position-relative stars" />
