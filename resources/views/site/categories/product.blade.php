    ...
    <section id="product-details" class="py-5 container">
        ...
        <div id="content-wrapper" class="row d-flex py-5">
            <div id="imgs-section" class="col-md-4 no-gutters">
                <div class="=row">
                    <img id="featured" class="w-100" src="{{$product ->images[0]->photo ?? asset('images/default.png')}}" alt="{{$product->name}}" />
                </div>
                <!-- Slider Nav imgs -->
                <div id="slide" class="d-flex justify-content-between flex-wrap mt-2">
                    <img class="thumbnail active" src="{{$product->images[0]->photo ?? asset('images/default.png')}}" alt="{{$product->name}}" />
                    <img class="thumbnail" src="{{$product ->images[1]->photo ?? asset('images/default.png')}}" alt="{{$product->name}}" />
                    <img class="thumbnail" src="{{$product ->images[2]->photo ?? asset('images/default.png')}}" alt="{{$product->name}}" />
                    <img class="thumbnail" src="{{$product ->images[3]->photo ?? asset('images/default.png')}}" alt="{{$product->name}}" />
                    <img class="thumbnail" src="{{$product ->images[4]->photo ?? asset('images/default.png')}}" alt="{{$product->name}}" />
                    <img class="thumbnail" src="{{$product ->images[5]->photo ?? asset('images/default.png')}}" alt="{{$product->name}}" />
                </div>
                <!-- Link -->
                    ...
                    <div class="col-6 col-md-3 no-gutters border-secondary border-top  py-1">
                        ...
                        <div id="seller-info" class="border-top border-secondary d-flex text-start px-2">
                            <div class="col-7 no-gutters">
                                <p class="text-large seller-name">اسم البائع</p>
        ...
        <div class="collections pt-5 text-start">
            <div class="container">
                <ul class="nav nav-tabs justify-content-start border-bottom border-dark py-2 text-large" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link  border-0" id="description-tab" data-toggle="tab" href="#description" role="tab" aria-controls="description" aria-selected="true">وصف</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  border-0" id="more-info-tab" data-toggle="tab" href="#more-info" role="tab" aria-controls="more-info" aria-selected="false">معلومات اضافية</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active border-0" id="reviwes-tab" data-toggle="tab" href="#reviwes" role="tab" aria-controls="contact" aria-selected="false">المراجعات</a>
                    </li>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade" id="description" role="tabpanel" aria-labelledby="description-tab">
                        <div id="description-text" class=" d-flex flex-wrap py-4 text-bold text-start">
                            النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن
                            تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التي يولدها التطبيق إذا كنت تحتاج
                            إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي
                            أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه الخصوص، حيث يحتاج العميل في كثير من الأحيان أن
                            يطلع على صورة حقيقية لتصميم الموقع

                            ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملا
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade show " id="more-info" role="tabpanel" aria-labelledby="more-info-tab">
                        <div class=" d-flex flex-row flex-wrap py-4 text-bold text-large">
                            <div class="col-12 my-2 col-md-6 ">
                                ...
                                <div class="px-2">قطن بنسبة 60% /بولستر بنسبة 40%</div>
                    ...
                    <div class="tab-pane fade show active py-5" id="reviwes" role="tabpanel" aria-labelledby="reviwes-tab">
                        <div class=" d-flex flex-row flex-wrap pt-3 pb-5 text-bold text-large bg-light">
                                    ...
                                    <div class="circle-wrap">
                                        <div class="circle">
                                            ...
                                            <div class="inside-circle ">
                                                ...
                                                <div class="position-absolute total-rate">4.2</div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 my-2  pt-3  col-md-6 border-right ">
                                ...
                                <div class="answer text-small">لو اشتريت منتج من كيان و ممكن تدخل علي "الطلبات" وبعدين تدوس علي
                                    "تقديم تقييم"</div>


                                <div class="question text-smaller main-color">أزاي بتتحسب التقيمات؟</div>
                                <div class="answer text-small">التقيمات من عملاء كيان الذين اشترو المنتج وكتبو تقييم</div>
                            ...
                            <div class="w-100 text-normal">
                                <div class=" d-flex flex-wrap d-flex review my-4 justify-content-center text-start  ">
                                    ...
                                    <div class="col-12 col-md-7 px-3 align-content-center align-content-md-start">
                                        ...
                                        <div class="review-customer-review py-1">خامة جميله بالنسبه لسعره قصة مناسبه ومقاس مظبوط</div>
                            ...
                            <div class="text-small w-100 text-end px-3">
            ...
            <div id="fast-order" class="container text-start">
                ...
                <div class="d-flex justify-content-center justify-content-md-start flex-wrap my-1">
                    ...
                    <button class="d-flex col-10 col-md-3 my-2 py-2 mx-md-5 bg-add-to-cart text-larger align-items-center">
        ...
        <div class="row my-5 pt-5">
            <div class="col-12">
                ...
                <div class="card-deck d-flex flex-wrap">
                    ...
                    <div class="card mt-4">
                        <input type="hidden" name="product_id" value="{{$vendor_product->id }}" id="product_page_product_id">
                        <div class="position-relative">
                            <div class="position-absolute w-100 p-3 item-assets">
                                ...
                                <form action="{{route('cart.store')}}" method="POST">
                                    ...
                                    <button type="submit" name="product_id" value="{{$vendor_product->id}}" class="add-to-cart btn py-1 px-2">
                                        أضف إلى العربة
                                    </button>
                                </form>
                            </div>
                            <img class="card-img-top" src="{{$vendor_product->images[0]->photo}}" alt="{{$vendor_product->name}}" />
                        </div>
                        ...
                        <div class="position-relative">
                            <div class="position-absolute w-100 p-3 item-assets">
                                ...
                                <form action="{{route('cart.store')}}" method="POST">
                                    ...
                                    <button type="submit" name="product_id" value="{{$related_product->id}}" class="add-to-cart btn py-1 px-2">
                                        أضف إلى العربة
                                    </button>
                                </form>
                            </div>
                            <img class="card-img-top" src="{{$related_product ->images[0]->photo ?? ''}}" alt="{{$related_product->name}}" />
                        </div>
