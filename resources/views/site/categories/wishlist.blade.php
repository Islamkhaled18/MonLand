                            ...
                            <div class="col-12 col-lg-2 position-relative">
                                <div
                                    ...
                                    <i class="fa-solid fa-trash-can"></i>
                                            ...
                                            <a class="removeFromWishlist btn bg-light" href="#"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-5 button-col d-flex flex-column justify-content-end">
                                            <div class="row">
                                                ...
                                                <button data-toggle="modal" data-target="#show{{ $product->id }}"
                                                    type="button" class="btn btn-dark my-1 col-5 col-lg-7">
                                                    نظرة سريعة
                                                </button>
                                            </div>
                                            <div class="row">
                                                <form action="{{ route('cart.store') }}" method="POST">
                                                    ...
                                                    <button type="submit" name="product_id"
                                                        value="{{ $product->id }}" class="btn btn-dark my-1">>
                                                        اضف الي العربة
                                                    </button>
                                                </form>
                                            </div>
