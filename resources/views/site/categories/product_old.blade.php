        ...
        <div id="content-wrapper" class="row d-flex py-5">
            ...
            <div id="text-section" class="col-md-8 px-md-5">
                ...
                <div class="d-flex my-3">
                    ...
                    @if (isset($product) && $product->qty !== null && $product->qty <= 20) <!-- Rating End-->
                ...
                <ul class="nav nav-tabs justify-content-start border-bottom border-dark py-2 text-large" id="myTab"
                    ...
                    <li class="nav-item">
                        <a class="nav-link  border-0" id="more-info-tab" data-toggle="tab" href="#more-info" role="tab"
                            aria-controls="more-info" aria-selected="false">معلومات اضافية</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card-deck d-flex flex-wrap">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body text-center">
                            <h5 class="card-title"><a href="{{ route('Site.product', $vendor_product->name) }}">{{
                                    $vendor_product->name }}</a>
                            </h5>
            ...
            <div class="col-12">
                ...
                <div class="card-deck d-flex flex-wrap">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body text-center">
                            <h5 class="card-title"><a href="{{ route('Site.product', $related_product->name) }}">{{
