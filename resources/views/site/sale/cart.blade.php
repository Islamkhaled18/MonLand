...
<section id="my-cart" class=" container mt-5">
    ...
    <div class="col-12 d-flex flex-wrap justify-content-center justify-content-lg-between my-2">
        ...
        <button class="bg-transparent text-normal px-2 mt-2 py-2 my-lg-0 justify-self-end border-main-color defualt-raduis">
            تابع
            التسوق</i></button>
    </div>
    <!-- Start Here -->
        ...
        <div class="col-12 col-lg-8 mb-4 no-gutters cart product_data">
            ...
            <div class=" border-with-raduis mb-4">
                ...
                <div class="row mt-3 mx-3 cart-item rounded">
                    <div class="col-12 col-lg-2 no-gutters  d-flex justify-content-start"><img class="product-img"  src="{{$cart->products->images[1]->photo ? asset($cart->products->images[1]->photo) : asset('images/default.png')}}" width="120" height="120" alt="{{$cart->products->name}}">
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        $('.increment-btn').click(function(e) {
            ...
            activate_deactivate_btn($(this), $(this).parents('.quantity-counter').find('.decrement-btn'), value)
        });
        $('.decrement-btn').click(function(e) {
            ...
            activate_deactivate_btn($(this).parents('.quantity-counter').find('.increment-btn'), $(this), value)
        });
