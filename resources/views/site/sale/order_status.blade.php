...
@section('content')
@if ($order->status == "تم استلام الطلبيه والعمل عليها" || $order->status == "تم الالغاء بواسطتنا" || $order->status == "تم الالغاء من العميل" )
...
<section id="my-cart" class=" container mt-5">
    ...
    <div class="col-12 d-flex flex-wrap justify-content-center justify-content-lg-between my-2">
        ...
        <div class="alert py-1 p-2 col-12 col-lg-9 no-gutters d-flex justify-content-between defualt-raduis  text-large">
            ...
            <div class="cart-list pb-2">
                ...
                <div class="order-box mb-5">
                    ...
                    <div class="border-with-raduis ">
                        <div class="d-flex flex-row align-items-center text-start main-color border-bottom border-dark py-2">
                            <div class="col">
                                <i class="fas fa-shipping-fast"></i>شحنة {{$loop->iteration}} من {{$countProdcts}}
                            </div>
                        ...
                        <div class="row mt-3 mx-3 cart-item rounded">
                            <div class="col-12 col-lg-2 no-gutters d-flex justify-content-start">
                                <img class="product-img img-fluid" src="../imgs/fav/fav-card-img.jpg" />
                            </div>
                            <div class="col-12 col-lg-7 text-start cart-item-details d-flex flex-column text-large">
                                <span class="py-2"> {{$cart->products->name}}</span>
                                <span class="">اللون : أسود</span>
                            ...
                            <div class="col-12 col-lg-3 d-flex flex-column justify-content-between  no-gutters pb-3 ">
                                <span class="mb-4 mt-4 text-end text-large">{{$cart->products->price }} جنيه</span>
                                <div class=" quantity-counter d-flex flex-nowrap justify-content-center align-items-center ">
                                    <input type="hidden" class="product_id" value="{{ $cart->product_id }}">
                                ...
                                <button data-toggle="modal" data-target="#show{{$cart->products->id}}" class="bg-main text-warning px-3 py-2 w-100  text-larger align-self-end">
                                    اكتب تقيم المنتج
                                </button>

                                <div class="modal fade" id="show{{$cart->products->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <form id="form-review" method="post" action="{{route('review.store')}}">
                                                        @csrf
                                                        <input type="text" name="product_id" value="{{$cart->products->id}}">
                                            ...
                                            <div class="modal-footer border-0">
                                                <button type="button" type="submit" class="btn btn-secondary mx-1 bg-main button-review" data-dismiss="modal">إرسال
                                                </button>
                    ...
                    <button class="col-6 bg-main text-warning px-3 py-2 align-self-end" data-toggle="modal" data-target="#show{{$product->id}}">
                        اكتب تقيم للبائع
                    </button>

                    <div class="modal fade" id="show{{$product->id}}" tabindex="-1" role="dialog" aria-labelledby="11" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header flex-row-reverse align-items-center bg-main text-white">

                                    <h5 class="modal-title text-center w-100" id="11">مراجعة البائع</h5>
                                    <button type="button" class="close m-0 p-0" data-dismiss="modal">
                                        <span class="text-white">&times;</span>
                                    </button>
                                </div>
                                ...
                                <div class="modal-footer border-0">
                                    <button type="button" type="submit" class="btn btn-secondary mx-1 bg-main button-review-vendor" data-dismiss="modal">إرسال
                                    </button>
                                    <button type="button" class="btn btn-dark">إلغاء</button>
                                </div>
                                </form>
