        ...
        <section id="my-cart" class="container mt-5">
            ...
            @if ($vendors_cart_count > 0 && $vendors_cart_count <= 1)
                <div class="d-flex flex-wrap justify-content-around pb-3 pt-5">
                                    ...
                                    @foreach ($products as $product)
                                        ...
                                        <div class="border-with-raduis ">
                                            <div
                                                ...
                                                <div class="col"><i class="fas fa-store"></i>
                                                    {{ $product->vendor_name }}
                                                </div>
                                            ...
                                            <!-- total-->
                                            <div
                                                class="d-flex justify-content-between align-items-center mx-3 pb-3 rounded">
                                                <div class="d-flex flex-row">
                                                    <div class="ml-2">
                                        ...
                                        <button class="col-6 bg-main text-warning px-3 py-2 align-self-end vendor"
                                            data-toggle="modal" data-vendorid="{{ $product->id }}"
                    ...
                    <div class="modal fade" id="seemodal" tabindex="-1" role="dialog" aria-labelledby="11"
                        aria-hidden="true">
                                    ...
                                    <div class="row">
                                        ...
                                        <form id="form-review-vendor" method="post"
                                            ...
                                            <div class="col-12 d-flex align-items-center my-4">
                                                ...
                                                <div class="rate mx-2">
                                                    <input type="radio" id="star10" name="star_rating"
                                                        value="5" />
                                                    <label for="star10" title="text">5 stars</label>
                                                    <input type="radio" id="star9" name="star_rating"
                                                        value="4" />
                                                    <label for="star9" title="text">4 stars</label>
                                                    <input type="radio" id="star8" name="star_rating"
                                                        value="3" />
                                                    <label for="star8" title="text">3 stars</label>
                                                    <input type="radio" id="star7" name="star_rating"
                                                        value="2" />
                                                    <label for="star7" title="text">2 stars</label>
                                                    <input type="radio" id="star6" name="star_rating"
                                                        value="1" />
                            ...
                            <div class="modal-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <form id="form-review" method="post" action="{{ route('review.store') }}">
                                            ...
                                            <div class="col-12 d-flex align-items-center my-4">
                                                ...
                                                <div class="rate mx-2">
                                                    <input type="radio" id="star5" name="star_rating"
                                                        value="5" />
                                                    <label for="star5" title="text">5
                                                        stars</label>
                                                    <input type="radio" id="star4" name="star_rating"
                                                        value="4" />
                                                    <label for="star4" title="text">4
                                                        stars</label>
                                                    <input type="radio" id="star3" name="star_rating"
                                                        value="3" />
                                                    <label for="star3" title="text">3
                                                        stars</label>
                                                    <input type="radio" id="star2" name="star_rating"
                                                        value="2" />
                                                    <label for="star2" title="text">2
                                                        stars</label>
                                                    <input type="radio" id="star1" name="star_rating"
                                                        value="1" />
                                ...
                                <div class="modal-footer border-0">
                                    <button type="button" type="submit"
                                        class="btn btn-secondary mx-1 bg-main button-review" data-dismiss="modal">إرسال
                                    </button>
