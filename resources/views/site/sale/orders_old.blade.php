    ...
    <div class=" d-flex flex-wrap justify-content-around py-3">
        <div class="col-12 col-lg-8 mb-4 no-gutters cart">
            <div class="d-flex flex-column justify-content-start align-items-start text-start mb-5">
                ...
                <form id="form-checkout-updateOrder" action="{{ route('checkout.updateOrder') }}" class="w-100"
                    method="post">
                    @csrf
            ...
            @if ($vendors_cart_count > 0 && $vendors_cart_count <= 1) <!-- cart list -->
                    ...
                    <div class=" border-with-raduis mb-4">
                        ...
                        <div class=" border-with-raduis mb-4">
                            <div
                                ...
                                <div class="col-6"><i class="fa-solid fa-motorcycle"></i> التوصيل في خلال 5
                                    أيام
                                    عمل </div>
