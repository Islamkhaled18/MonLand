                ...
                <div class="card-body">
                    ...
                    <form class="mt-5" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="email" id="email" class="form-control mt-4 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                            @error('email')
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input type="password" id="password" class="form-control mt-4 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
